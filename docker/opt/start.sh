#!/bin/sh
# Preparando todas las variables como IP, nombre de host, etc., todas ellas desde el contenedor
sleep 5
HOSTNAME=$(hostname -a)
DOMAIN=$(hostname -d)
...
zimbraPrefTimeZoneId="America/Guayaquil"
...
echo "Ya puede acceder a Zimbra Collaboration Server"
